...
Învățarea federată a apărut ca direcție de cercetare odată cu FedAvg \cite{mcmahan2017fedavg}, ca răspuns direct la problema discutată în secțiunea anterioară - cum poate fi antrenat un model pe datele mai multor clienți, fără ca acestea să fie centralizate pe un server. De atunci, domeniul s-a diversificat, acoperind variante de agregare, metode de confidențialitate diferențială, robustețe la clienți adversariali și scenarii de personalizare \cite{kairouz2021advances}. Pentru a situa CultureQuest în acest cadru, ne putem ghida după două axe de clasificare devenite standard în literatură: tipul de FL, în funcție de cum sunt distribuite datele între clienți, și modul de desfășurare, în funcție de cine sunt clienții și care este comportamentul lor.
