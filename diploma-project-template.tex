...
Modelul de recomandare al CultureQuest este un perceptron multi-strat (MLP, \textit{Multi-Layer Perceptron}). Arhitectura este simplă: un număr mic de straturi complet conectate, pornind de la cele 22 de caracteristici asociate obiectivelor turistice și culturale. Pe dispozitiv, modelul nu este folosit doar pentru antrenarea locală, ci și pentru afișare - de fiecare dată când utilizatorul deschide pagina cu informații a unui obiectiv turistic, aplicația face o nouă trecere \textit{forward pass} prin model, ca să calculeze scorul de potrivire afișat pentru turist. Tocmai pentru că rulează la fiecare interacțiune, modelul trebuia să fie o implementare proprie, cât mai ușoară și fără dependențe externe.
