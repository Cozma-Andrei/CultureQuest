...
| Zhang, C., Xie, Y., Bai, H., Yu, B., Li, W., & Gao, Y. (2021). A survey on federated learning. *Knowledge-Based Systems*, 216, 106775. | Context general/taxonomie FL. | 1.1 |
...
| Nguyen, J., Malik, K., Zhan, H., Yousefpour, A., Rabbat, M., Malek, M., & Huba, D. (2022). Federated Learning with Buffered Asynchronous Aggregation (FedBuff). *arXiv:2106.06639*. | Agregare asincronă cu buffer - considerată o cale de mijloc între FedAvg sincron și varianta complet asincronă; marcată ca lucrare viitoare. | 7.2 |
